...
function esDiezOCinco(numero) {
  ...
  // Tu código
  if (numero == 10 || numero == 5); //puedo colocar luego de los () return true, pero no es necesario ya que esto dara true si numero es 10 o 5.
}
...
function fizzBuzz(numero) {
  ...
  if (numero % 15 == 0) return "fizzbuzz";  //Tambien se puede escribir así: if (numero % 3 === 0 && numero % 5 == 0) return "fizzbuzz";
